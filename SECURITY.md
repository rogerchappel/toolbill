...
Replace this section with the supported versions for `toolbill`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `toolbill` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in toolbill.
